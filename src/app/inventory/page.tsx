...
// const CarCard = ({ car }) => {
//   return (
//     <div className="bg-white min-w-[200px] border relative rounded-lg shadow-md overflow-hidden">
//       {/* Status Badge */}
//       {car.status && (
//         <span
//           className={`
...
//           ${
//             car.status === "New" ? "bg-green-100 text-green-800" :
...
//           </div>
//           <p className="font-bold text-md">₦{car.price.toLocaleString()}</p>
//         </div>
...
//         <button className="mt-2 w-full py-1 px-2 border border-gray-300 rounded-md text-xs font-medium hover:bg-red-600 hover:text-white transition-colors">
//           View car Details
//         </button>
//       </div>
//     </div>
...
const CarCard: React.FC<CarCardProps> = ({ car }) => (
  <div className="bg-white border relative rounded-lg shadow-md overflow-hidden">
    ...
    <div className="p-2 sm:p-3">
      ...
      <p className="font-bold text-sm sm:text-md text-left">₦{car.price.toLocaleString()}</p>
      ...
      {/* Location - only shown on mobile */}
      {/* <div className="flex items-center gap-1 mt-1 sm:hidden">
        <span className="text-xs text-gray-500">Lagos State, Lekki</span>
      </div> */}
